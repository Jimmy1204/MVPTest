...
public class JsonRequestUtil {
    ...
    /**
     * 在同一局域网测试下 服务器的ip地址106.14.57.117:80
     */
    static public final String IP = "http://106.14.57.117:80/safetyteaching/";

    //static public final String getTestJson = IP + "muser_login";

    public static String getServerRequestUrl(String requestUrl) {
        String url = IP + requestUrl;
        return url;
    }
    ...
    static class PostThread extends Thread {
        ...
        @Override
        public void run() {
            res = JsonRequestUtil.post(toUrl, content);
        }
    }
        ...
        switch (Method) {
            ...
            case 3:
                try {
                    ...
                    reader.close();
                    Log.i("@JOSNERROR", response.toString());
                    connection.disconnect();
